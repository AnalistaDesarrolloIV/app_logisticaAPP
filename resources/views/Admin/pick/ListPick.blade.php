...
@section('content')
    ...
    <div class="container-fluid mx-3 mt-4" id="content">
                    ...
                    <form action="{{route('storeAsign')}}" method="post" id="Form_asig">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <select class="form-select select2_m" id="operatore" aria-label="Default select example" name="operatore">
                                    <option selected value="">Seleccione</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select select2_m" id="prioridad" aria-label="Default select example" name="prioridad">
                                    <option selected value="">Seleccione</option>
                                    <option value="Baja">Baja</option>
                                    <option value="Media">Media</option>
                                    <option value="Alta">Alta</option>
