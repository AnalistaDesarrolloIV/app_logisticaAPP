    ...
    <div class="container-fluid justify-content-end">
      ...
      <div class="collapse navbar-collapse navegacion justify-content-between" id="navbarNavAltMarkup">
        <div class="navbar-nav">
          <a class="nav-link home px-3" aria-current="page" href="{{route('opcionesAdmin')}}"><i class="fas fa-home"></i> Inicio</a>
          <a class="nav-link picking px-3" href="{{route('listPick')}}"><i class="fas fa-tasks"></i> Asignación Pedidos </a>
        </div>
